...
--
-- Table structure for table `tbl_ccl_audit`
--

DROP TABLE IF EXISTS `tbl_ccl_audit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_ccl_audit` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `ip_address` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_ccla_entity` (`entity_type`,`entity_id`),
  KEY `idx_ccla_user` (`user_id`),
  KEY `idx_ccla_date` (`action_date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='CCL: structured audit trail for all CCL workflow actions';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_ccl_audit`
--

LOCK TABLES `tbl_ccl_audit` WRITE;
/*!40000 ALTER TABLE `tbl_ccl_audit` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_ccl_audit` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_ccl_eoc`
--

DROP TABLE IF EXISTS `tbl_ccl_eoc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_ccl_eoc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `schedule_id` int(11) NOT NULL,
  `outgoing_crew_id` int(11) NOT NULL,
  `vessel_id` int(11) NOT NULL,
  `rank_id` int(11) DEFAULT NULL,
  `sign_on_date` date DEFAULT NULL,
  `sign_off_date` date DEFAULT NULL,
  `eoc_status` varchar(30) NOT NULL DEFAULT 'Generated',
  `generated_by` int(11) NOT NULL,
  `generated_at` datetime NOT NULL DEFAULT current_timestamp(),
  `cancelled_at` datetime DEFAULT NULL,
  `remarks` text DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_eoc_per_crew` (`schedule_id`,`outgoing_crew_id`),
  KEY `fk_eoc_schedule` (`schedule_id`),
  KEY `fk_eoc_crew` (`outgoing_crew_id`),
  KEY `fk_eoc_vessel` (`vessel_id`),
  CONSTRAINT `fk_eoc_crew` FOREIGN KEY (`outgoing_crew_id`) REFERENCES `tbl_personnel_info` (`id`),
  CONSTRAINT `fk_eoc_schedule` FOREIGN KEY (`schedule_id`) REFERENCES `tbl_ccl_schedules` (`id`),
  CONSTRAINT `fk_eoc_vessel` FOREIGN KEY (`vessel_id`) REFERENCES `tbl_vessels` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='CCL: auto-generated EOC records; unique per schedule+crew';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_ccl_eoc`
--

LOCK TABLES `tbl_ccl_eoc` WRITE;
/*!40000 ALTER TABLE `tbl_ccl_eoc` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_ccl_eoc` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_ccl_relievers`
--

DROP TABLE IF EXISTS `tbl_ccl_relievers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_ccl_relievers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vessel_id` int(11) NOT NULL,
  `outgoing_crew_id` int(11) NOT NULL,
  `reliever_crew_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_cclr_vessel` (`vessel_id`),
  KEY `fk_cclr_out` (`outgoing_crew_id`),
  KEY `fk_cclr_rel` (`reliever_crew_id`),
  KEY `fk_cclr_creator` (`created_by`),
  KEY `idx_cclr_status` (`status`),
  CONSTRAINT `fk_cclr_creator` FOREIGN KEY (`created_by`) REFERENCES `tbl_users` (`id`),
  CONSTRAINT `fk_cclr_out` FOREIGN KEY (`outgoing_crew_id`) REFERENCES `tbl_personnel_info` (`id`),
  CONSTRAINT `fk_cclr_rel` FOREIGN KEY (`reliever_crew_id`) REFERENCES `tbl_personnel_info` (`id`),
  CONSTRAINT `fk_cclr_vessel` FOREIGN KEY (`vessel_id`) REFERENCES `tbl_vessels` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='CCL: reliever assignments; one active record per outgoing crew per vessel';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_ccl_relievers`
--

LOCK TABLES `tbl_ccl_relievers` WRITE;
/*!40000 ALTER TABLE `tbl_ccl_relievers` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_ccl_relievers` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_ccl_schedules`
--

DROP TABLE IF EXISTS `tbl_ccl_schedules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_ccl_schedules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `reliever_id` int(11) NOT NULL,
  `vessel_id` int(11) NOT NULL,
  `crew_id` int(11) NOT NULL,
  `joining_date` date NOT NULL,
  `joining_port` varchar(200) NOT NULL,
  `departure_date` date NOT NULL,
  `ship_onsign_date` date NOT NULL,
  `schedule_status` varchar(30) NOT NULL DEFAULT 'Tentative',
  ...
  `date_updated` datetime DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `fk_ccls_reliever` (`reliever_id`),
  KEY `fk_ccls_vessel` (`vessel_id`),
  KEY `fk_ccls_crew` (`crew_id`),
  KEY `idx_ccls_status` (`schedule_status`),
  CONSTRAINT `fk_ccls_crew` FOREIGN KEY (`crew_id`) REFERENCES `tbl_personnel_info` (`id`),
  CONSTRAINT `fk_ccls_reliever` FOREIGN KEY (`reliever_id`) REFERENCES `tbl_ccl_relievers` (`id`),
  CONSTRAINT `fk_ccls_vessel` FOREIGN KEY (`vessel_id`) REFERENCES `tbl_vessels` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='CCL: crew-change schedules (Tentative / Next / Completed / Cancelled)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_ccl_schedules`
--

LOCK TABLES `tbl_ccl_schedules` WRITE;
/*!40000 ALTER TABLE `tbl_ccl_schedules` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_ccl_schedules` ENABLE KEYS */;
UNLOCK TABLES;
