...
<head>
    ...
    <title>Sign In — UMMI Crew Management</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .lp-features { position: relative; z-index: 1; margin-top: 40px; }
        .lp-feature {
        ...
        .login-btn:hover { background: #1d4ed8; box-shadow: 0 4px 12px rgba(37,99,235,0.3); }
        ...
        @media (max-width: 768px) {
            ...
            .login-panel-right { background: #F0F4F8; }
        }
    </style>
</head>
<body>
